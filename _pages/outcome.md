...
<div class="row">
  <div class="col-md-4 mb-4">
    <img src="/assets/img/projects/adc.png" class="img-fluid rounded" alt="ADC Chip Design">
    <p class="text-center mt-2">14bit SAR-ADC Chip Design</p>
  </div>
  <div class="col-md-4 mb-4">
    <img src="/assets/img/projects/readout.png" class="img-fluid rounded" alt="PCB Layout">
    <p class="text-center mt-2">Infrared focal plane array digital ROIC</p>
  </div>
</div>
...
<div class="row">
  <div class="col-md-4 mb-4">
    <img src="/assets/img/projects/solider.jpg" class="img-fluid rounded" alt="The soldier">
    <p class="text-center mt-2">The soldier from ROBOMASTER</p>
  </div>
  <div class="col-md-4 mb-4">
    <img src="/assets/img/projects/engineer.jpg" class="img-fluid rounded" alt="The engineer">
    <p class="text-center mt-2">The engineer from ROBOMASTER</p>
  </div>
  <div class="col-md-4 mb-4">
