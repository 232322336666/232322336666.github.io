    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-an-failure-submission-to-vlsi2026-but-i-will-continue-to-try",
          title: 'An failure submission to VLSI2026, but I will continue to try.',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/FuZhengnan_CV.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
